...
export const updateWeeklyForecast = (weatherData) => {
    ...
    for (let i = 1; i <= 4; i++) {
      ...
      degreesElement.textContent = `${fahrenheitToCelsius(forecastData.Temperature.Minimum.Value)}°C Low / ${fahrenheitToCelsius(forecastData.Temperature.Maximum.Value)}°C High`;
